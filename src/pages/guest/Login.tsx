...
export default function Login() {
  const { signInWithEmail, signInWithGoogle, signInWithApple, profile, user, loading } = useAuth();
  ...
  useEffect(() => {
    ...
    else if (profile?.role === "instructor") navigate("/instructors", { replace: true });
    else navigate("/students", { replace: true });
  }, [from, loading, navigate, pendingNav, profile?.role, user]);
